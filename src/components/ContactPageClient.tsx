...
const GOOGLE_FORM_BASE =
  "https://docs.google.com/forms/d/e/1FAIpQLSdGskMl9fzHZ89t78-JgOP5jvGmtkOGhNPsAKjaqDuHhmG6Vw/viewform";
  ...
  return (
    <div className="overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white shadow-card">
      ...
      <div className="relative h-[300px] bg-slate-100">
        <iframe
          title="707 Holdings Chicago Office Map"
          src={embedSrc}
...
export default function ContactPageClient() {
  ...
  const submitUrl = useMemo(() => {
    const params = new URLSearchParams({
      usp: "pp_url",
      "entry.454892663": organizationName,
      "entry.781986437": contactPerson,
      "entry.604739016": phoneNumber,
      "entry.1053983057": emailAddress,
      "entry.2123967211": pickupLocation,
      "entry.1095850134": deliveryLocation,
      "entry.1293247207": typeOfDelivery,
      "entry.1223120580": frequency,
    });
        ...
        <div className="grid gap-8 xl:grid-cols-[1.2fr_0.9fr]">
          <div className="rounded-[1.75rem] border border-slate-200 bg-white p-8 shadow-card sm:p-10">
            ...
            <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-600">
              Fill out the form below and our Chicago logistics team will reach
            ...
            <form onSubmit={handleSubmit} className="mt-10">
              ...
              <button
                type="submit"
                className="mt-8 inline-flex h-14 w-full items-center justify-center rounded-xl bg-brand-green px-6 text-lg font-semibold text-white shadow-card transition hover:bg-brand-greenMedium"
              >
                Request Courier Service
              </button>
            </form>
